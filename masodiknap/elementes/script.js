...
const availableCards = [
    { id: 1, name: "Harcos", type: "unit", element: "earth", attack: 5, defense: 3, isCustom: false },
    { id: 2, name: "Varázsló", type: "unit", element: "fire", attack: 7, defense: 2, isCustom: false },
    { id: 3, name: "Íjász", type: "unit", element: "air", attack: 4, defense: 2, isCustom: false },
    { id: 4, name: "Lovag", type: "unit", element: "earth", attack: 6, defense: 5, isCustom: false },
    { id: 7, name: "Óriás", type: "unit", element: "earth", attack: 10, defense: 8, isCustom: false },
    { id: 8, name: "Sárkány", type: "unit", element: "fire", attack: 12, defense: 10, isCustom: false },
    { id: 9, name: "Pap", type: "unit", element: "water", attack: 2, defense: 4, isCustom: false },
    { id: 10, name: "Orgyilkos", type: "unit", element: "air", attack: 9, defense: 1, isCustom: false }
];
...
function renderPlayerCards() {
    ...
    availableCards.forEach(card => {
        ...
        cardEl.className = `card-item ${card.element}`;
...
function simulateBattle() {
    ...
    const finalEnemyCards = enemyCards.length > 0 ? enemyCards : [
        { name: "Sötét Varázsló", attack: 8, defense: 3, type: "unit", element: "fire" },
        { name: "Éjjeli Árnyék", attack: 6, defense: 2, type: "unit", element: "air" }
    ];

    const finalPlayerCards = playerCards.length > 0 ? playerCards : [
        { name: "Harcos", attack: 5, defense: 4, type: "unit", element: "earth" },
        { name: "Íjász", attack: 4, defense: 2, type: "unit", element: "air" }
    ];
...
function displayCards(cards, containerId) {
    ...
    cards.forEach(card => {
        ...
        cardElement.className = `battle-card ${card.type} ${card.element}`;
